...
__FINALLY__, by bringing these **people problems** together, the **underlying issues
    ...
    - Diminishing Self-Worth* will surface becoming more visible to the unaffected. Which is the inertia we seek. 
        - Allowing for 
...
>
> *We had to develop a site and model for SXSW evaluators and are in process of circling back to fully develop the concept **they viewed the page on Tuesday 25 November, Twenty 19 according to GitHub's Insightful Analytics**
...
5. The **Fundable CEO** is sending emails to crowdsource on their platform.

6. The industries **oldest marketing, branding, and advertising agency** has touched base *after a solicited pitch this past summer we'd all but forgotten about.**

> __Seriously need a CTO__  and somehow must figure out how to skyrocket progression of technical proficiencies; to be able to 
    - Take all this momentum and 
        - Convert it into an MVP and 
            - Scalable framework
                - This could make for one amazing business pitch, and 
                - Almost immediate profitability if 
                    - somehow we were align and 
